    ...
    <div>
      ...
      <div className="flex justify-center mt-20">
        <div className="bg-secondary rounded-[21px] w-[302px] h-[50px] font-bold relative flex items-center justify-center">
          <Link href={'/auth/loginstudent'} className="text-white text-[16px]">LOGIN AS STUDENT</Link>
        </div>
      </div>

      <div className="flex justify-center mt-3 font-normal" style={{ marginLeft: '39px', marginRight: '39px' }}>
        <span className="text-lightblue text-[12px] underline">Need help?</span>
      </div>

      <div className="flex justify-center mt-7" style={{ marginLeft: '103px', marginRight: '102px' }}>
