      ...
      <div className="mt-[138px] ml-[43px] text-[36px]">
        ...
        <div className="mt-[46px]">
          ...
          <div className="flex flex-col">
            ...
            <input
              className="rounded-[11px] border-black h-[46px] w-[438px] border mt-[5px]"
              type="text"
            />
          </div>
          ...
          <div className="mt-14 flex flex-col max-w-[438px] ">
            <button
              onClick={handleClick}
              className={` ${rethink_sans.className} font-semibold text-2xl w-[438px] h-[48px] bg-blue1 text-center text-white rounded-[13px] `}
            >
              Login
            </button>
            ...
            <div className="text-center">
              <Link
                href={"/help"}
                className={` ${rethink_sans.className}    font-normal mt-[22px] text-base underline `}
              >
                Need help?
              </Link>
            </div>
